...
(function ($) {
    ...
    $.jSlots = function (el, options) {
        ...
        $.jSlots.defaultOptions = {
            ...
            loops: 6,
            endsAt: []// Number: times it will spin during the animation
        };
...
//            console.log("Step 3: "+base.liCount);
...
//            console.log("Step 4 - Base Slots: "+JSON.stringify(base.allSlots));
        ...
        base.bindEvents = function () {
            $(base.options.spinner).bind(base.options.spinEvent, function (event) {
                if (!base.isSpinning) {
//                    console.log("Step 5 - Bind Events");
                    base.playSlots();
                }
            });
        };
        ...
        base.Slot.prototype = {
            // do one rotation
            spinEm: function () {
//                console.log("Step 7 - Spin each Slot");
...
//                    console.log("Step 8 - Lower Speed & Spin");
                    this.spinEm();

                } else {
//                    console.log("Step 8 - Lower Speed & Finish");
                    this.finish();
            ...
            finish: function () {
                ...
                var finalPos = -(endNum * 100);
                var finalSpeed = ((this.spinSpeed * 0.5) * (base.liCount)) / endNum;

//                console.log("Step 9 - Finishing the spining: Final Pos: " + finalPos + " Final Speed: " + finalSpeed);
...
//            console.log("Step 10 Checking Winners: " + endNum);
...
//                console.log("Step 6 - OnStart Options");
                base.options.onStart(base);
            }

//For each base slot,call spin
            $.each(base.allSlots, function (index, val) {
//                console.log("Play Slots: " + JSON.stringify(val));
                this.spinSpeed = 0;
                this.loopCount = 0;
                this.isSpinning = true;
                this.spinEm();
